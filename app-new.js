...
**🚫 No AI stages**: Some work must come entirely from your own observation, reading, creation, or experience. AI cannot reconstruct, enhance, or generate this foundational work. These stages protect the authenticity of primary engagement.

**🤝 AI as Co-Intelligence stages**: After forming your own analysis, you may use AI to test interpretations, surface blind spots, or refine arguments. AI helps you think more rigorously but cannot replace your thinking. Specific productive and unproductive uses will be defined for each assignment.

**🛠️ AI as Tool stages**: AI may be required for visualization, design, or communication tasks. You maintain authorship of ideas while using AI for implementation.
...
"I know many of you have strong feelings about AI—some of you love using it, some are skeptical, some are confused about what's allowed. Here's my approach: I'm not interested in blanket rules because AI isn't one thing. It can be genuinely helpful for some tasks and genuinely harmful for others.
...
Here's the pattern you'll see: First, I'll ask you to do something that requires your direct experience or observation—AI can't do this for you because it wasn't there. Then, after you've formed your own interpretation, you can use AI as a thinking partner to test and refine your ideas. Finally, you might use AI as a communication tool.

If you ever wonder why a specific AI boundary exists, ask me. I can explain the pedagogical reasoning, and if you disagree, we can talk about it. But following these boundaries isn't optional—it's how the learning happens."
...
**Faculty response**: "I understand the impulse, but here's what would actually happen: AI would smooth over the specific, messy, sometimes awkward details that make your observation valuable. Those rough edges—moments of confusion, surprising details you noticed, things that didn't fit your expectations—that's the raw material for genuine analysis. If AI 'improves' Stage 1, you lose what makes your work worth analyzing in Stage 2. You're not avoiding AI because it's bad; you're avoiding it because you need authentic primary material to work with."

---

**Student: "How will you know if I used AI when I wasn't supposed to?"**

**Faculty response**: "Honestly? Sometimes it's obvious—AI has tells, like unnaturally polished writing disconnected from specific details, or analysis that could apply to anything rather than your specific situation. But here's what matters more: if you use AI in Stage 1, you won't have genuine material to work with in Stage 2. The assignment won't work for you. You'll struggle to write Stage 2 because you'll be trying to analyze something you didn't actually observe or experience. The constraint isn't there to catch cheaters—it's there because without it, you can't do the intellectual work the assignment requires."`,
...
**The harm**: AI doesn't reconstruct memory—it generates plausible content based on patterns. The student ends up with AI-generated organizational behavior that sounds realistic but didn't actually happen. They lose their specific, authentic observation.
...
**The harm**: The student skips the most important cognitive work—wrestling with their observations to form their own interpretation. They end up defending AI's interpretation rather than developing their own analytical thinking.
...
**Excellent** - Work demonstrates direct, unmediated engagement with source material. Includes specific, concrete details that could only come from personal observation/experience. Shows evidence of authentic noticing—including surprising, confusing, or unexpected elements.
        ...
        <header>
            <div className="container">
                <div className="header-content">
                    <div className="logo">
                        <a href="https://www.wlu.edu/harte-center" style={{color: 'white', textDecoration: 'none'}}>
        ...
        <div>
            <div className="assignment-overview">
                <div className="overview-section">
                    <h4>What students create</h4>
                    <p>
                        A research proposal examining human behavior through direct observation, interpreted using 
                    ...
                    <p>
                        ...
                        theory, they develop the foundational skill of empirical reasoning—seeing what actually happens 
            ...
            <Accordion title="Behavioral Observation" badge="Stage 1" defaultOpen={true}>
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <h4>AI Permissions: None</h4>
                        <p>
                            This stage requires your direct observation of actual human behavior. AI cannot observe 
                        ...
                        <p>
                            ...
                            sequences, timing, who did what. No psychological interpretation yet—that comes in 
                    ...
                    <PedagogyPanel>
                        <h4>Why no AI here?</h4>
                        <p>
                            Psychology is an empirical science built on systematic observation. Students need 
                        ...
                        <h4>What would break?</h4>
                        <p>
                            If students could use AI in this stage, they would unconsciously shift from recording 
                        ...
                        <p>
                            Students may resist this constraint, wanting to immediately explain what they're seeing. 
                            However, forcing them to separate observation from interpretation builds the empirical 
                            discipline central to psychological science—distinguishing data from theory.
                        </p>

                        <h4>Disciplinary connection</h4>
                        <p>
                            In psychology, the ability to observe behavior systematically without theoretical bias 
                            is foundational to research methods. This stage builds that capacity—learning to see 
            ...
            <Accordion title="Theoretical Analysis" badge="Stage 2">
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <p>
                            2-3 pages analyzing your observations through psychological theory, demonstrating how AI 
                    ...
                    <PedagogyPanel>
                        ...
                        <p>
                            ...
                            and challenge weak reasoning—exactly what good psychological training should provide.
                        </p>
                        ...
                        <h4>Disciplinary connection</h4>
                        <p>
                            In psychological research, having your theoretical interpretation challenged is normal—by 
            ...
            <Accordion title="Research Design or Intervention" badge="Stage 3">
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <h4>What Students Deliver</h4>
                        <p>
                            A research proposal (2-3 pages) including: hypothesis derived from your Stage 2 analysis, 
                    ...
                    <PedagogyPanel>
                        <h4>Why AI here?</h4>
                        <p>
                            Research design requires considering many methodological details—sampling, measurement, 
                        ...
                        <p>
                            ...
                            show clear connection from observed behavior → theoretical interpretation → testable hypothesis, 
                        ...
                        <p>
                            ...
                            ensures students can move from interpretation to investigation—the core cycle of psychological 
                            science.
                        </p>
                    </PedagogyPanel>
                </div>
            ...
            <div className="assignment-overview">
                <div className="overview-section">
                    ...
                    <p>
                        ...
                        they develop the foundational skill of empirical economics—letting data inform theory rather 
                ...
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <p>
                            ...
                            emerge? Create tables, charts showing the raw data. No economic interpretation yet—that's 
                    ...
                    <PedagogyPanel>
                        <h4>Why no AI here?</h4>
                        <p>
                            Economists must be able to locate, extract, and work with real economic data. If students 
                        ...
                        <h4>What would break?</h4>
                        <p>
                            If students could use AI here, they would get AI-generated summaries rather than learning 
                        ...
                        <h4>What to expect?</h4>
                        <p>
                            Students may find primary data sources more complex than expected. However, this challenge 
                            is precisely what builds economic literacy—learning to work with messy, real-world data 
                            rather than sanitized examples.
                        </p>

                        <h4>Disciplinary connection</h4>
                        <p>
                            In economics, the ability to work with primary data sources is foundational to empirical 
                            research. This stage builds that capacity—learning to document economic reality before 
            ...
            <Accordion title="Economic Analysis and Modeling" badge="Stage 2">
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <h4>What Students Deliver</h4>
                        <p>
                            3-4 pages analyzing your data through economic theory, showing how specific models or 
                    ...
                    <PedagogyPanel>
                        ...
                        <p>
                            ...
                            and challenge weak causal reasoning—exactly what good economics training should provide.
                        </p>
                        ...
                        <h4>Disciplinary connection</h4>
                        <p>
                            In economics, having your analysis challenged is normal—by other economists, conflicting 
            ...
            <Accordion title="Policy Recommendations" badge="Stage 3">
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <h4>What Students Deliver</h4>
                        <p>
                            2-3 pages of evidence-based policy recommendations, showing clear connection from data → 
                            economic analysis → policy implications. Address potential counterarguments and 
                    ...
                    <PedagogyPanel>
                        <h4>Why AI here?</h4>
                        <p>
                            Policy requires anticipating many considerations—distributional effects, political 
                        ...
                        <p>
                            ...
                            connection from documented data → theoretical interpretation → policy implications, with 
                        ...
                        <p>
                            ...
                            move from analysis to recommendations—the core purpose of applied economic work.
                        </p>
                    </PedagogyPanel>
                </div>
            </Accordion>
            ...
            <div className="assignment-overview">
                <div className="overview-section">
                    ...
                    <p>
                        ...
                        they develop the foundational skill of experimental science—gathering authentic data before 
                ...
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <p>
                            ...
                            yet—that's Stage 2. Right now, show you can conduct experiments and collect reliable data.
                        </p>
                    ...
                    <PedagogyPanel>
                        <h4>Why no AI here?</h4>
                        <p>
                            Chemistry is an experimental science. Students need hands-on experience conducting 
                        ...
                        <h4>What would break?</h4>
                        <p>
                            If students could use AI in this stage, they would shift from documenting what actually 
                            happened to describing what theory predicts should happen. They would lose the messy 
                            reality of real experiments—the unexpected results, procedural challenges, and 
                            troubleshooting that build experimental competence.
                        </p>

                        <h4>What to expect?</h4>
                        <p>
                            Students may initially resist documenting "failures" or unexpected results. However, 
                        ...
                        <h4>Disciplinary connection</h4>
                        <p>
                            In chemistry, experimental technique and careful observation are foundational. This stage 
                            builds those capacities—learning to work with real chemical systems before imposing 
            ...
            <Accordion title="Chemical Analysis and Interpretation" badge="Stage 2">
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <h4>What Students Deliver</h4>
                        <p>
                            Lab report (3-4 pages) analyzing your experimental results through chemical principles, 
                    ...
                    <PedagogyPanel>
                        ...
                        <p>
                            ...
                            of error, and challenge weak reasoning—exactly what good chemistry training should provide.
                        </p>
            ...
            <Accordion title="Application or Experimental Design" badge="Stage 3">
                <div className="accordion-panels">
                    <div className="accordion-panel panel-student">
                        ...
                        <h4>What Students Deliver</h4>
                        <p>
                            Proposal (2-3 pages) for extended investigation or application, showing clear connection 
                            from experimental observations → chemical analysis → next steps. Address feasibility, 
                    ...
                    <PedagogyPanel>
                        <h4>Why AI here?</h4>
                        <p>
                            Moving from lab-scale to application requires considering many factors—scaling, safety, 
                        ...
                        <p>
                            ...
                            from lab observations → chemical interpretation → practical applications, with AI supporting 
                        ...
                        <p>
                            ...
                            can move from experimental results to real-world impact—the core purpose of applied chemical 
                            research.
                        </p>
                    </PedagogyPanel>
                </div>
...
function Footer() {
    const handleCopyDisclaimer = () => {
        const disclaimerText = "Human-conceptualized resource combining human-written content and AI-generated material under human direction, editing, and review.";
            ...
            <div className="container">
                ...
                <div className="footer-content">
                    ...
                    <p className="footer-copyright">
                        © 2026 <a href="https://www.wlu.edu/harte-center" target="_blank" rel="noopener noreferrer">Harte Center for Teaching and Learning</a>, Washington and Lee University. All rights reserved.
                    </p>
                    ...
                    <button className="footer-copy-btn" onClick={handleCopyDisclaimer} aria-label="Copy disclaimer text">
                        Copy
                    </button>
                </div>
            </div>
