...
**Excellent (A range)** - Work demonstrates direct, unmediated engagement with source material. Includes specific, concrete details that could only come from personal observation/experience. Shows evidence of authentic noticing—including surprising, confusing, or unexpected elements.

**Proficient (B range)** - Work shows genuine engagement with source material. Includes specific details, though may occasionally slip into generalizations. Mostly captures authentic observation with minimal AI-enhanced smoothing.

**Developing (C range)** - Work contains mix of authentic observation and generic or theoretical description. Lacks specific concrete details; could describe many similar situations. May be overly polished for Stage 1 documentation.

**Needs Revision (D/F range)** - Work appears to be AI-generated hypothetical scenario rather than authentic observation. Contains only generic details that could apply to any situation.

---

### Stage 2: Conceptual Interpretation with AI Co-Intelligence

**Excellent (A range)** - Interpretation is clearly grounded in specific Stage 1 observations. Analysis reveals original thinking that connects observations to concepts in novel ways. Shows evidence of using AI to stress-test interpretation. Co-Intelligence Appendix shows sophisticated understanding of where AI helped vs. where human judgment was essential.

**Proficient (B range)** - Interpretation connects Stage 1 observations to conceptual frameworks appropriately. Shows some original analytical thinking with AI support. Makes reasonable claims supported by evidence.

**Developing (C range)** - Interpretation feels somewhat disconnected from specific Stage 1 observations. Analysis may rely heavily on AI-generated insights with insufficient student development.

**Needs Revision (D/F range)** - Interpretation appears to be AI-generated from Stage 1 content with minimal student contribution. Generic analysis that could apply to any situation, not grounded in student's specific observations.`
};
            ...
            <div className="container">
                <div className="footer-content">
                    <div className="footer-text">
                        © 2025 Washington and Lee University Teaching and Learning Center
                    </div>
